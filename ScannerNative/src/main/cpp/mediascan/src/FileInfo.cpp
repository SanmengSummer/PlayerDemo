...
std::ostream &operator<<(std::ostream &os, const FileInfo &info) {
    os << "mFilePath:" << info.mFilePath << ";mFileName:" << info.mFileName << ";mParentPath:"
       << info.mParentPath
       << ";mFileSize:" << info.mFileSize << ";mFileModTime:" << info.mFileModTime
       << ";mFileChangeTime:"
...
std::ostream &operator<<(std::ostream &os, const MediaInfo &info) {
    os << static_cast<const FileInfo &>(info) << "mTitle:" << info.mTitle << ";mArtist:"
       << info.mArtist
       << ";mAlbum:" << info.mAlbum <<";mComposer:" << info.mComposer << ";mGenre:"
       << info.mGenre << ";mYear:"
